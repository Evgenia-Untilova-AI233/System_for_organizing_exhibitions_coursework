...
import ua.opnu.jenya.Security.AuthRequest;
...
public class JwtController {
    ...
    @Autowired
    public JwtController(UserRepository userRepository, PasswordEncoder passwordEncoder, AuthenticationManager authenticationManager, AuthTokenGenerator authTokenGenerator) {
